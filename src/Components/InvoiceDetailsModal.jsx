        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/40 p-4">
            <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-lg relative">
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={onClose} className="rounded-lg px-2 py-1 text-sm ring-1 ring-gray-300 hover:bg-gray-100">X</button>
                </div>
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                    ...
                    {invoice.status === "Mismatch" && (
                        <div className="col-span-2 text-red-600">
                            <strong>Reason:</strong> {invoice.mismatchReason}
                        </div>
                    )}
                </div>
